...
cd /opt/elk-simple/
wget https://raw.githubusercontent.com/dkaminski/azure-diagnostics-tools/master/ELK-Semantic-Logging/ELK/AzureRM/elk-simple-on-ubuntu/elasticsearch-ubuntu-install.sh
wget https://raw.githubusercontent.com/dkaminski/azure-diagnostics-tools/master/ELK-Semantic-Logging/ELK/AzureRM/logstash-on-ubuntu/logstash-install-ubuntu.sh
wget https://raw.githubusercontent.com/dkaminski/azure-diagnostics-tools/master/ELK-Semantic-Logging/ELK/AzureRM/elk-simple-on-ubuntu/kibana4-install-ubuntu.sh
